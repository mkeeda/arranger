...
kotlin {
    sourceSets {
        commonMain.dependencies {
            ...
            implementation("dev.mkeeda.arranger:arranger-richtext-editor:0.3.0-alpha01")

            // Optional: If you only need the core data structures without Compose UI:
            // implementation("dev.mkeeda.arranger:arranger-richtext:0.3.0-alpha01")
        }
    }
}
```
...
> ```kotlin
> dependencies {
>     implementation("dev.mkeeda.arranger:arranger-richtext-editor-material3:0.3.0-alpha01")
> }
> ```
